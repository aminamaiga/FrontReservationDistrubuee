...
namespace FrontReservation.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> Index(String ville = "", String nomHotel = "", String categorie = "",
            String nombrePersonne = "", DateTime? dateDepart = null, DateTime? dateArrivee = null)
        {
           ...
           if (dateDepart != null)
            ...
            using (var client = new HttpClient())
            {
                ...
                HttpResponseMessage Res = await client.GetAsync("search-by-usager?" + search);
